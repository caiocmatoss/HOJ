...
assert("Event Detail uses real optional fields only", eventDetail.includes("event.image") && eventDetail.includes("event.description") && eventDetail.includes("event.category") && eventDetail.includes("event.date") && eventDetail.includes("event.time"));
