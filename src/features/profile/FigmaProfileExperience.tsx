...
export default function FigmaProfileExperience() {
  ...
  return <ScrollView style={styles.page} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
    <View style={styles.hero}>
      ...
      <Image source={require("../../../assets/images/profile-cover.jpg")} resizeMode="cover" style={styles.heroCover} />
      <LinearGradient colors={["transparent", colors.background]} start={{ x: 0.5, y: 0.35 }} end={{ x: 0.5, y: 1 }} style={styles.heroFade} />
...
const styles: any = StyleSheet.create({
  ...
  heroAvatar: { position: "absolute", left: 20, bottom: -26, borderRadius: 40, borderWidth: 3, borderColor: colors.background },
